...
/*
 * It’s similar to advance() in that it reads the
 * next token. But it also validates that
...
/*Code for parking prefix expressions*/
static void expression() {
...
ParseRule rules[] = {
  ...
  { c_number,   NULL,    PREC_NONE },       // TOKEN_NUMBER
